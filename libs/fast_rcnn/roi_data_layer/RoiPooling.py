...
class RoiPooling(Layer):
    ...
    '''
    def __init__(self, pool_list, num_rois, spatial_scale, **kwargs):
    ...
    def call(self, x, mask=None):
        ...
        for roi_idx in range(self.num_rois):
            ...
            x = rois[roi_idx,0]*self._spatial_scale
            y = rois[roi_idx,1]*self._spatial_scale
            w = rois[roi_idx,2]*self._spatial_scale
            h = rois[roi_idx,3]*self._spatial_scale
        ...
        out_shape = (1,self.num_rois,self.nb_channels * self.num_outputs_per_channel)
        #out_shape = (1,-1)
        #print 'out_shape: ', out_shape
        final_output = K.reshape(final_output, out_shape)
        print 'final_output.shape: ', final_output.shape
        
        #final_output = K.variable(value=final_output)
